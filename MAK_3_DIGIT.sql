--------------------------------------------------------
--  DDL for View MAK_3_DIGIT
--------------------------------------------------------

  CREATE OR REPLACE VIEW "SCPOMGR"."MAK_3_DIGIT" ("'U_30_SRC_DAILY_PART2B'", "ITEM", "DEST", "SOURCE", "TRANSMODE", "EFF", "FACTOR", "ARRIVCAL", "MAJORSHIPQTY", "MINORSHIPQTY", "ENABLEDYNDEPSW", "SHRINKAGEFACTOR", "MAXSHIPQTY", "ABBR", "SOURCING", "DISC", "MAXLEADTIME", "MINLEADTIME", "PRIORITY", "ENABLESW", "YIELDFACTOR", "SUPPLYLEADTIME", "COSTPERCENTAGE", "SUPPLYTRANSFERCOST", "NONEWSUPPLYDATE", "SHIPCAL", "FF_TRIGGER_CONTROL", "PULLFORWARDDUR", "SPLITQTY", "LOADDUR", "UNLOADDUR", "REVIEWCAL", "USELOOKAHEADSW", "CONVENIENTSHIPQTY", "CONVENIENTADJUPPCT", "CONVENIENTOVERRIDETHRESHOLD", "ROUNDINGFACTOR", "ORDERGROUP", "ORDERGROUPMEMBER", "LOTSIZESENABLEDSW", "CONVENIENTADJDOWNPCT") AS 
