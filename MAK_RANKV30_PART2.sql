--------------------------------------------------------
--  DDL for View MAK_RANKV30_PART2
--------------------------------------------------------

  CREATE OR REPLACE VIEW "SCPOMGR"."MAK_RANKV30_PART2" ("SECTION", "ITEM", "DEST", "SOURCE", "TRANSMODE", "EFF", "FACTOR", "ARRIVCAL", "MAJORSHIPQTY", "MINORSHIPQTY", "ENABLEDYNDEPSW", "SHRINKAGEFACTOR", "MAXSHIPQTY", "ABBR", "SOURCING", "DISC", "MAXLEADTIME", "MINLEADTIME", "PRIORITY", "ENABLESW", "YIELDFACTOR", "SUPPLYLEADTIME", "COSTPERCENTAGE", "SUPPLYTRANSFERCOST", "NONEWSUPPLYDATE", "SHIPCAL", "FF_TRIGGER_CONTROL", "PULLFORWARDDUR", "SPLITQTY", "LOADDUR", "UNLOADDUR", "REVIEWCAL", "USELOOKAHEADSW", "CONVENIENTSHIPQTY", "CONVENIENTADJUPPCT", "CONVENIENTOVERRIDETHRESHOLD", "ROUNDINGFACTOR", "ORDERGROUP", "ORDERGROUPMEMBER", "LOTSIZESENABLEDSW", "CONVENIENTADJDOWNPCT") AS 
      ...
      ,
        ...
        *********************************************************************/
        ...
        select all_lanes.item
          ...
          , all_lanes.u_max_src
          ,all_lanes.distance
          , rank() over ( partition by all_lanes.item, all_lanes.dest order by cost_pallet, source asc ) as rank
        from
            /*********************************************************************
