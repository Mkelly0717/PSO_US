...
--------------------------------------------------------
  ...
  select r.source, r.loc, skc.item, skc.eff, r.res, fc.percen,  skc.qty, fc.percen*skc.qty lane_qty
from res r, udt_fixed_coll fc, skuconstraint skc
...
order by r.source, r.loc, skc.eff
