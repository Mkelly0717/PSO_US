--------------------------------------------------------
--  DDL for View UDV_SOURCE_TO_CUST_SUMMARY
--------------------------------------------------------

  CREATE OR REPLACE VIEW "SCPOMGR"."UDV_SOURCE_TO_CUST_SUMMARY" ("SRC_SOURCE", "SRC_ITEM", "SM_NDESTS", "SM_QTY_SHIPPED", "SRC_NDESTS", "DEMAND_QTY") AS 
