--------------------------------------------------------
--  DDL for View U_04_SRCMETRIC
--------------------------------------------------------

  CREATE OR REPLACE VIEW "SCPOMGR"."U_04_SRCMETRIC" ("ITEM", "DEST", "SOURCE", "SOURCING", "CATEGORY", "DESCR", "VALUE", "TOTAL_COST", "TOTAL_EXEC", "A0504", "A0511", "A0518", "A0525", "A0601", "A0608", "A0615", "A0622", "A0629", "A0706", "A0713", "A0720", "A0727", "A0803", "A0810", "A0817", "A0824", "A0831", "A0907", "A0914", "A0921", "A0928", "A1005", "A1012", "A1019", "A1026", "A1102", "A1109", "A1116", "A1123", "A1130", "A1207", "A1214", "A1221", "A1228", "A0104", "A0111", "A0118", "A0125", "A0201", "A0208", "A0215", "A0222", "A0301", "A0308", "A0315", "A0322", "A0329", "A0405", "A0412", "A0419", "A0426") AS 
  SELECT u.item,
            u.dest,
            u.source,
            u.sourcing,
       ...
       FROM (SELECT r.item,
                    ...
                    c.localcost,
                    t.VALUE
               FROM sourcingrequirement r, rescost c, costtier t
              WHERE r.res = c.res AND c.localcost = t.cost) e,
            (  SELECT DISTINCT
                      c.item,
                      c.dest,
                      c.source,
                ...
                WHERE c.category = m.category AND c.category IN (418, 475)
             GROUP BY c.item,
                      c.dest,
                      c.source,
                      c.sourcing,
                      ...
                      m.descr) u
      WHERE     u.dest = e.dest(+)
            AND u.source = e.source(+)
            AND u.item = e.item(+)
            AND u.sourcing = e.sourcing(+)
   ORDER BY u.category, u.item, u.dest
