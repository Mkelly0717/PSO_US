--------------------------------------------------------
--  DDL for View U_65_PRODUCTIONMETRIC_WK
--------------------------------------------------------

  CREATE OR REPLACE VIEW "SCPOMGR"."U_65_PRODUCTIONMETRIC_WK" ("ITEM", "OUTPUTITEM", "YIELDQTY", "PRODRATE", "LOC", "OH", "PRODUCTIONMETHOD", "CATEGORY", "DESCR", "PROXY", "SUB_QTY", "TOTAL_EXEC", "P1", "P2", "P3", "P4", "P5", "P6", "P7", "P8", "P9", "P10", "P11", "P12", "P13", "P14", "P15", "P16", "P17", "P18", "P19", "P20", "P21", "P22", "P23", "P24", "P25", "P26") AS 
     ...
     (  SELECT u.item, u.outputitem, u.yieldqty, u.prodrate, u.loc, u.oh, u.productionmethod, u.category, u.descr, t.sc_qty, b.proxy, b.sub_qty,
               ...
               (  SELECT DISTINCT c.item, y.outputitem, c.loc, s.oh, c.productionmethod, y.yieldqty, q.prodrate, c.category, m.descr,
                        ...
                        NVL (SUM (CASE WHEN c.eff = s.ohpost + 175 THEN VALUE*y.yieldqty END), 0) p26
                         FROM udt_productionmetric_wk c, metriccategory m, productionstep q, productionyield y, sku s
                    ...
                    (  SELECT DISTINCT c.item,y.outputitem, y.yieldqty, s.prodrate, c.loc, c.productionmethod, c.category, m.descr, SUM (VALUE) * y.yieldqty sc_qty
                         FROM udt_productionmetric_wk c, metriccategory m, productionyield y, productionstep s
                        WHERE     c.category = m.category
                              AND c.category IN (418)
                              AND c.item = y.item
                              AND c.loc = y.loc
                    ...
                    from udt_productionmetric_wk m, productionmethod p, bom b
