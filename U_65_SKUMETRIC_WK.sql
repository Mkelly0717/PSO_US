--------------------------------------------------------
--  DDL for View U_65_SKUMETRIC_WK
--------------------------------------------------------

  CREATE OR REPLACE VIEW "SCPOMGR"."U_65_SKUMETRIC_WK" ("ITEM", "MATCODE", "QB", "LOC", "LOC_TYPE", "CATEGORY", "DESCR", "TOTAL", "P1", "P2", "P3", "P4", "P5", "P6", "P7", "P8", "P9", "P10", "P11", "P12", "P13", "P14", "P15", "P16", "P17", "P18", "P19", "P20", "P21", "P22", "P23", "P24", "P25", "P26") AS 
...
from
    ...
    nvl (sum (case when eff = s.ohpost + 175 then round(value, 2) end), 0) p26
                     FROM udt_skumetric_wk c, metriccategory m, sku s, item i, loc l
